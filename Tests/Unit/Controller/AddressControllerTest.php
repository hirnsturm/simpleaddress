...
/**
 * Test case for class Sle\Simpleaddress\Controller\AddressController.
 *
...
class AddressControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	protected function setUp() {
		$this->subject = $this->getMock('Sle\\Simpleaddress\\Controller\\AddressController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
